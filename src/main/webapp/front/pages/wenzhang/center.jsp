    ...
    <ul id="category">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="wenzhangUuidNumber" id="wenzhangUuidNumber" lay-verify="required" placeholder="文章编号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="wenzhangName" id="wenzhangName" lay-verify="required" placeholder="文章名称" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="wenzhangPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="wenzhangPhoto" name="wenzhangPhoto"/>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="wenzhangTypes" id="wenzhangTypes">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="wenzhangClicknum" id="wenzhangClicknum"  lay-verify="required|integer"   placeholder="点击次数" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`wenzhang/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#wenzhangPhotoImg").attr("src", data.data.wenzhangPhoto);
                });
